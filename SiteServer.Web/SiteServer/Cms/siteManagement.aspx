...
<frameset id="frame" framespacing="0" border="false" cols="180,*" frameborder="0" scrolling="yes">
	<frame name="tree" scrolling="auto" marginwidth="0"  style="display:none" marginheight="0" width="0" src="siteTree.aspx?PublishmentSystemID=<%=PublishmentSystemId%>" >  
	<frame name="content" scrolling="auto" marginwidth="0" marginheight="0" src="PagePublishmentSystem.aspx?PublishmentSystemID=<%=Request.QueryString["PublishmentSystemId"]%>">
</frameset>
<noframes>
<body>

...
<form class="form-inline" runat="server">
  ...
  <div class="well well-small">
    ...
    <div id="contentSearch" style="display:block;margin-top:10px;">
       分类：
      <asp:DropDownList ID="ChannelCategory" OnSelectedIndexChanged="ChannelCategory_SelectedIndexChanged"  AutoPostBack="true" class="input-medium" runat="server"> </asp:DropDownList>
      时间从：

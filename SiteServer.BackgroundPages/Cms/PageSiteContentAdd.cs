...
{
    public class PageSiteContentAdd : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            var nodeId = 1002;// Body.GetQueryInt("NodeID");
            var contentId = 3006;// Body.GetQueryInt("ID");
            ReturnUrl = StringUtils.ValueFromUrl(@"/siteserver/cms/pagecontent.aspx_question_PublishmentSystemID_equals_1_and_NodeID_equals_1002_and_DateFrom_equals__and_SearchType_equals__and_Keyword_equals__and_page_equals_1");// StringUtils.ValueFromUrl(Body.GetQueryString("ReturnUrl"));
